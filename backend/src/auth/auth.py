    ...
    if rsa_key:
        ...
        # catch common errors
            ...
            raise AuthError({
                'code': 'invalid_claims',
                'description': 
                'Invalid claims.Please check audience & issuer.'
            }, 401)
...
requires_auth(permission) decorator method
    ...
    check the requested permission return the decorator which passes t
    he decoded payload to the decorated method
'''
